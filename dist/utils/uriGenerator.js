...
var _routesCollection = _interopRequireDefault(require("./routesCollection"));
...
let URIGenerator = /*#__PURE__*/function () {
  function URIGenerator() {
    _classCallCheck(this, URIGenerator);
  }

  _createClass(URIGenerator, [{
    key: "getURI",
    value: function getURI(controllerAction, params, id) {
      const caArray = controllerAction.split('_');
      const routeData = _routesCollection.default[caArray[0]][caArray[1]];
    ...
    key: "bindParams",
    value: function bindParams(uri, params) {
      let match;
      let replacement;
      let uriParam = uri;
      ...
      if (Object.keys(paramsForQueryString).length > 0) {
        uriParam = `${uriParam}?${_queryString.default.stringify(paramsForQueryString)}`;
      }
